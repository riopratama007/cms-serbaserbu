<?php
 ...
 class WC_Gateway_Tripay_SAMPOERNA_VA extends Tripay_Payment_Gateway
 {
     public $sub_id = 'tripay_sampoernava';
    
     public function __construct()
     {
         parent::__construct();
         $this->method_title = 'TriPay - Sahabat Sampoerna VA';
         $this->method_description = "Pembayaran melalui Sahabat Sampoerna Virtual Account";
         $this->payment_method = 'SAMPOERNAVA';
         ...
         if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon'])
                ...
                : plugins_url('/assets/sampoerna-va.png', dirname(__FILE__));
        }
     }
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan Sahabat Sampoerna Virtual Account', 'wc-tripay'),
            ...
            'title' => array(
                ...
                'default' => __('Sahabat Sampoerna Virtual Account', 'wc-tripay'),
            ),
            'enable_icon' => array(
                'title' => __('Ikon Pembayaran', 'wc-tripay'),
                'label' => __('Aktifkan Ikon', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '<img src="'.plugins_url('/assets/sampoerna-va.png', dirname(__FILE__)).'" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ),
            'custom_icon' => array(
            ...
            'description' => array(
                ...
                'default' => 'Pembayaran melalui Sahabat Sampoerna Virtual Account',
            ),
            'expired' => array(
                'title' => __("Masa Aktif Nomor VA", "wc-tripay"),
                "type" => 'select',
                'description' => __('', 'wc-tripay'),
                'default' => '1',
                'options' => array(
