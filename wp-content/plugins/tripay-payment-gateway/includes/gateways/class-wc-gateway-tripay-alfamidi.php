<?php
 ...
 class WC_Gateway_Tripay_ALFAMIDI extends Tripay_Payment_Gateway
 {
     public $sub_id = 'tripay_alfamidi';
    
     public function __construct()
     {
         parent::__construct();
         $this->method_title = 'TriPay - Alfamidi';
         $this->method_description = "Pembayaran melalui Alfamidi";
         $this->payment_method = 'ALFAMIDI';
         ...
         if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon'])
                ...
                : plugins_url('/assets/alfamidi.png', dirname(__FILE__));
        }
     }
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan Alfamidi', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'no',
            ),
            'title' => array(
                ...
                'default' => __('Alfamidi', 'wc-tripay'),
            ),
            'enable_icon' => array(
                'title' => __('Ikon Pembayaran', 'wc-tripay'),
                'label' => __('Aktifkan Ikon', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '<img src="'.plugins_url('/assets/alfamidi.png', dirname(__FILE__)).'" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ),
            'custom_icon' => array(
            ...
            'description' => array(
                ...
                'default' => 'Pembayaran melalui Alfamidi',
            ),
            'expired' => array(
