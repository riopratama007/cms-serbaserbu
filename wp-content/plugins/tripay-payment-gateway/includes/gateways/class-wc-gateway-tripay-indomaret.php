<?php
 ...
 class WC_Gateway_Tripay_INDOMARET extends Tripay_Payment_Gateway
 {
     public $sub_id = 'tripay_indomaret';
    
     public function __construct()
     {
         parent::__construct();
         $this->method_title = 'TriPay - Indomaret';
         $this->method_description = "Pembayaran melalui Indomaret";
         $this->payment_method = 'INDOMARET';
         ...
         if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon'])
                ...
                : plugins_url('/assets/indomaret.png', dirname(__FILE__));
        }
     }
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan Indomaret', 'wc-tripay'),
            ...
            'title' => array(
                ...
                'default' => __('Indomaret', 'wc-tripay'),
            ),
            'enable_icon' => array(
                'title' => __('Ikon Pembayaran', 'wc-tripay'),
                'label' => __('Aktifkan Ikon', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '<img src="'.plugins_url('/assets/indomaret.png', dirname(__FILE__)).'" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ),
            'custom_icon' => array(
            ...
            'description' => array(
                ...
                'default' => 'Pembayaran melalui Indomaret',
            ),
            'expired' => array(
