<?php
 ...
 class WC_Gateway_Tripay_BRI_VA extends Tripay_Payment_Gateway
 {
     public $sub_id = 'tripay_briva';
    
     public function __construct()
     {
        parent::__construct();
        $this->method_title = 'TriPay - BRI VA';
        $this->method_description = "Pembayaran melalui BRI Virtual Account";
        $this->payment_method = 'BRIVA';
        ...
        if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon'])
                ...
                : plugins_url('/assets/bri-va.png', dirname(__FILE__));
        }
     }
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan BRI Virtual Account', 'wc-tripay'),
            ...
            'title' => array(
                ...
                'default' => __('BRI Virtual Account', 'wc-tripay'),
            ),
            'enable_icon' => array(
                'title' => __('Ikon Pembayaran', 'wc-tripay'),
                'label' => __('Aktifkan Ikon', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '<img src="'.plugins_url('/assets/bri-va.png', dirname(__FILE__)).'" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ),
            'custom_icon' => array(
            ...
            'description' => array(
                ...
                'default' => 'Pembayaran dengan BRI Virtual Account',
            ),
            'expired' => array(
