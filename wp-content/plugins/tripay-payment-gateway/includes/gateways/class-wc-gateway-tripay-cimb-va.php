<?php
 ...
 class WC_Gateway_Tripay_CIMB_VA extends Tripay_Payment_Gateway
 {
     public $sub_id = 'tripay_cimbva';
    
     public function __construct()
     {
         parent::__construct();
         $this->method_title = 'TriPay - CIMB Niaga VA';
         $this->method_description = "Pembayaran melalui CIMB Niaga Virtual Account";
         $this->payment_method = 'CIMBVA';
         ...
         if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon'])
                ...
                : plugins_url('/assets/cimb-va.png', dirname(__FILE__));
        }
     }
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan CIMB Niaga Virtual Account', 'wc-tripay'),
            ...
            'title' => array(
                ...
                'default' => __('CIMB Niaga Virtual Account', 'wc-tripay'),
            ),
            'enable_icon' => array(
                'title' => __('Ikon Pembayaran', 'wc-tripay'),
                'label' => __('Aktifkan Ikon', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '<img src="'.plugins_url('/assets/cimb-va.png', dirname(__FILE__)).'" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ),
            'custom_icon' => array(
            ...
            'description' => array(
                ...
                'default' => 'Pembayaran Melalui CIMB Niaga Virtual Account',
            ),
            'expired' => array(
