...
class WC_Gateway_Tripay_OCBC_VA extends Tripay_Payment_Gateway
{
    public $sub_id = 'tripay_ocbcva';

    public function __construct()
    {
        parent::__construct();
        $this->method_title = 'TriPay - OCBC NISP VA';
        $this->method_description = "Pembayaran melalui OCBC NISP Virtual Account";
        $this->payment_method = 'OCBCVA';
        ...
        if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon'])
                ...
                : plugins_url('/assets/ocbc-va.png', dirname(__FILE__));
        }
    }
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan OCBC NISP Virtual Account', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'no',
            ),
            'title' => array(
                ...
                'default' => __('OCBC NISP Virtual Account', 'wc-tripay'),
            ),
            'enable_icon' => array(
                'title' => __('Ikon Pembayaran', 'wc-tripay'),
                'label' => __('Aktifkan Ikon', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '<img src="' . plugins_url('/assets/ocbc-va.png', dirname(__FILE__)) . '" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ),
            'custom_icon' => array(
            ...
            'description' => array(
                ...
                'default' => 'Pembayaran melalui OCBC NISP Virtual Account',
            ),
            'expired' => array(
