     ...
     public function __construct()
     {
         ...
         if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon'])
                ...
                : plugins_url('/assets/shopeepay.png', dirname(__FILE__));
        }
     }
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            ...
            'enable_icon' => array(
                ...
                'type' => 'checkbox',
                'description' => '<img src="'.plugins_url('/assets/shopeepay.png', dirname(__FILE__)).'" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ),
            'custom_icon' => array(
