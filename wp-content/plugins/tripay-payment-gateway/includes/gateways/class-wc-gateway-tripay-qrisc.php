<?php
 ...
 class WC_Gateway_Tripay_QRISC extends Tripay_Payment_Gateway
 {
     public $sub_id = 'tripay_qrisc';
    
     public function __construct()
     {
         parent::__construct();
         $this->method_title = 'TriPay - QRIS Customizable';
         $this->method_description = "Pembayaran melalui Scan QR";
         $this->payment_method = 'QRISC';
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan QRIS Customizable', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'no',
            ),
            'title' => array(
                ...
                'default' => __('QRIS Customizable', 'wc-tripay'),
            ),
            'enable_icon' => array(
