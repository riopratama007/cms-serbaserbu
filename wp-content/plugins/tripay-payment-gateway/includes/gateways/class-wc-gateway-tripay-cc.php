<?php
 ...
 class WC_Gateway_Tripay_CC extends Tripay_Payment_Gateway
 {
     public $sub_id = 'tripay_cc';
    
     public function __construct()
     {
         parent::__construct();
         $this->method_title = 'TriPay - Kartu Kredit';
         $this->method_description = "Pembayaran melalui Kartu Kredit";
         ...
         if ($this->settings['enable_icon'] == 'yes') {
            $this->icon = !empty($this->settings['custom_icon'])
                ...
                : plugins_url('/assets/cc.png', dirname(__FILE__));
        }
     }
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan Kartu Kredit', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'no',
            ),
            'title' => array(
                ...
                'default' => __('Kartu Kredit', 'wc-tripay'),
            ),
            'enable_icon' => array(
                'title' => __('Ikon Pembayaran', 'wc-tripay'),
                'label' => __('Aktifkan Ikon', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '<img src="'.plugins_url('/assets/cc.png', dirname(__FILE__)).'" style="height:100%;max-height:40px !important" />',
                'default' => 'no',
            ),
            'custom_icon' => array(
            ...
            'description' => array(
                ...
                'default' => 'Pembayaran melalui Kartu Kredit',
            ),
            'expired' => array(
                'title' => __("Masa Berlaku Transaksi", "wc-tripay"),
                "type" => 'select',
                'description' => __('', 'wc-tripay'),
                'default' => '1',
                'options' => array(
